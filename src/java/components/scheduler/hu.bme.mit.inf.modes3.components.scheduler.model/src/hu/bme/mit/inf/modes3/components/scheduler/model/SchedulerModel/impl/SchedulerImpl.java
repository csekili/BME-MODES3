 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.inf.modes3.components.scheduler.model.SchedulerModel.impl.SchedulerImpl#getRoutes <em>Routes</em>}</li>
 *   <li>{@link hu.bme.mit.inf.modes3.components.scheduler.model.SchedulerModel.impl.SchedulerImpl#getSchedule <em>Schedule</em>}</li>
 *   <li>{@link hu.bme.mit.inf.modes3.components.scheduler.model.SchedulerModel.impl.SchedulerImpl#getStations <em>Stations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchedulerImpl extends MinimalEObjectImpl.Container implements Scheduler {
	...
	public EList<Route> getRoutes() {
		if (routes == null) {
			routes = new EObjectContainmentEList<Route>(Route.class, this, SchedulerPackage.SCHEDULER__ROUTES);
		}
		return routes;
	}
	...
	public NotificationChain basicSetSchedule(Schedule newSchedule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchedulerPackage.SCHEDULER__SCHEDULE, oldSchedule, newSchedule);
	...
	public void setSchedule(Schedule newSchedule) {
		if (newSchedule != schedule) {
			...
			if (schedule != null)
				msgs = ((InternalEObject)schedule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchedulerPackage.SCHEDULER__SCHEDULE, null, msgs);
			if (newSchedule != null)
				msgs = ((InternalEObject)newSchedule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchedulerPackage.SCHEDULER__SCHEDULE, null, msgs);
			msgs = basicSetSchedule(newSchedule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.SCHEDULER__SCHEDULE, newSchedule, newSchedule));
	}
	...
	public EList<Station> getStations() {
		if (stations == null) {
			stations = new EObjectContainmentEList<Station>(Station.class, this, SchedulerPackage.SCHEDULER__STATIONS);
		}
		return stations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SchedulerPackage.SCHEDULER__ROUTES:
				return ((InternalEList<?>)getRoutes()).basicRemove(otherEnd, msgs);
			case SchedulerPackage.SCHEDULER__SCHEDULE:
				return basicSetSchedule(null, msgs);
			case SchedulerPackage.SCHEDULER__STATIONS:
